<template>
  <div class="privacy">
    <h1 class="privacy__title">Политика обработки персональных данных и cookie</h1>
    <div class="privacy__body">
      <h2 class="privacy__sub-title">1. Общие положения</h2>
      <p>
      ...
      <p class="privacy__inn text-muted">ИНН: 891001018354</p>
      <p class="privacy__ogrn text-muted">ОГРН: 321547600190647</p>
      <h2 class="privacy__sub-title">2. Общие положения</h2>
      <p>
      ...
      <h2 class="privacy__sub-title">2. Основные понятия, используемые в Политике</h2>
      <p>
      ...
      <p>
        ...
        Пользователю веб-сайта <strong>https://chloe-dankina.ru</strong>
      </p>
      <p>
      ...
      <p>2.10. Пользователь — любой посетитель веб-сайта <strong>https://chloe-dankina.ru</strong></p>
      <p>
      ...
      <h2 class="privacy__sub-title">3. Основные права и обязанности Оператора</h2>
      ...
      <ul class="privacy__list">
        ...
        <li type="disc">исполнять иные обязанности, предусмотренные Законом о персональных данных.</li>
      </ul>
      <h2 class="privacy__sub-title">4. Основные права и обязанности субъектов персональных данных</h2>
      ...
      <ul class="privacy__list">
        ...
        <li type="disc">на осуществление иных прав, предусмотренных законодательством РФ.</li>
      </ul>
      <p>4.2. Субъекты персональных данных обязаны:</p>
      <ul class="privacy__list">
        <li type="disc">предоставлять Оператору достоверные данные о себе;</li>
        <li type="disc">сообщать Оператору об уточнении (обновлении, изменении) своих персональных данных.</li>
      </ul>
      <p>
      ...
      <h2 class="privacy__sub-title">5. Принципы обработки персональных данных</h2>
      ...
      <h2 class="privacy__sub-title">6. Цели обработки персональных данных</h2>
      <table class="privacy__table">
        <tbody>
          <tr>
            <td class="title">Цель обработки</td>
            <td>
              Анализ поведения пользователей на сайте, улучшение работы и функциональности сайта, обеспечение работы
              интерактивных элементов (карт).
            </td>
          </tr>

          <tr>
            <td class="title">Персональные данные</td>
            <td>
              Данные, собираемые автоматически с помощью файлов cookie и аналогичных технологий (IP-адрес, данные о
              местоположении, действия на сайте, технические характеристики устройства и браузера).
            </td>
          </tr>

          <tr>
            <td class="title">Правовые основания</td>
            <td>Согласие субъекта персональных данных.</td>
          </tr>

          <tr>
            <td class="title">Виды обработки персональных данных</td>
            <td>Сбор, запись, систематизация, накопление, хранение, обезличивание, удаление.</td>
          </tr>
        </tbody>
      </table>
      <h2 class="privacy__sub-title">7. Условия обработки персональных данных</h2>
      <p>
      ...
      <p>
        7.8. Обработка данных, собираемых с помощью файлов cookie (куки), осуществляется на основании согласия
        Пользователя, за исключением файлов, необходимых для технического функционирования сайта.
      </p>
      ...
      <p>
        ...
        <strong>info@chloe-dankina.ru</strong> с пометкой «Актуализация персональных данных».
      </p>
      <p>
        ...
        электронной почты на электронный адрес Оператора <strong>info@chloe-dankina.ru</strong> с пометкой «Отзыв
      ...
      <h2 class="privacy__sub-title">10. Использование файлов cookie (куки)</h2>
      <p>
        10.1. На данном Сайте используются файлы cookie и другие аналогичные технологии. Cookie — это небольшой
        текстовый файл, который сохраняется на устройстве Пользователя при посещении веб-сайта. Он помогает Сайту
        «запоминать» действия и настройки Пользователя (например, язык, шрифт) в течение определенного периода времени,
        чтобы не вводить их заново при каждом посещении сайта и при переходе со страницы на страницу.
      </p>
      <p>10.2. Оператор использует файлы cookie для следующих целей:</p>
      <table class="privacy__table">
        <tbody>
          <tr>
            <td class="title">Аналитические:</td>
            <td>
              Для анализа поведения пользователей на Сайте, оценки его работы и улучшения его содержания и
              функциональности. Сбор данных для этой цели осуществляется с помощью сервиса Яндекс.Метрика.
            </td>
          </tr>

          <tr>
            <td class="title">Функциональные:</td>
            <td>
              Для обеспечения работы интерактивных функций Сайта, таких как карты Яндекс.Карты, онлайн запись "DIKIDI".
            </td>
          </tr>

          <tr>
            <td class="title">Технические:</td>
            <td>
              Для обеспечения технического функционирования Сайта, таких как файлы cookie и другие аналогичные
              технологии.
            </td>
          </tr>
        </tbody>
      ...
      <p>
        10.3. Согласие на обработку данных с помощью аналитических и функциональных cookie запрашивается у Пользователя
        при первом посещении Сайта через всплывающее окно (баннер). Пользователь может принять или отклонить их
        использование.
      </p>
      <p>
        10.4. Управление файлами cookie (их отключение) может быть осуществлено Пользователем через настройки его
        интернет-браузера. Инструкции по настройке для популярных браузеров доступны по официальным ссылкам
        разработчиков. Оператор обращает внимание, что отключение необходимых для работы Сайта cookie может привести к
        ухудшению или невозможности использования некоторых функций Сайта.
      </p>

      <h2 class="privacy__sub-title">11. Конфиденциальность персональных данных</h2>
      <p>
      ...
      <h2 class="privacy__sub-title">12. Заключительные положения</h2>
      <p>
        ...
        <strong>info@chloe-dankina.ru</strong>
      </p>
      <p>
      ...
      <p>
        ...
        <strong>https://chloe-dankina.ru/privacy</strong>.
      </p>
    </div>
  </div>
</template>
