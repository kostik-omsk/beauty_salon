  ...
  <div class="privacy">
    ...
    <div class="privacy__body">
      ...
      <p>
        ...
        путем направления Оператору уведомление на адрес электронной почты Оператора <strong>@gmail.com</strong> с
      ...
      <p>
        ...
        электронной почты на электронный адрес Оператора <strong>@gmail.com</strong> с пометкой «Отзыв согласия на
